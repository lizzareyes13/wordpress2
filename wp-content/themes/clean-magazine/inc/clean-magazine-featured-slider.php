				...
				<section id="feature-slider">
					<div class="wrapper">
						<div class="cycle-slideshow"
							...
							// Select Slider
							if ( 'demo-featured-slider' == $sliderselect  && function_exists( 'clean_magazine_demo_slider' ) ) {
								$clean_magazine_featured_slider .=  clean_magazine_demo_slider( $options );
							}
							elseif ( 'featured-page-slider' == $sliderselect  && function_exists( 'clean_magazine_page_slider' ) ) {
